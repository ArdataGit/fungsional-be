...
const chatTicketRouter = require('#api/chat-ticket/route.js');
...
router.use('/api/user-activity', userActivityRouter);
...
router.use('/api/admin/chat-ticket', chatTicketRouter);
